...
import com.mosioj.ideescadeaux.model.repositories.columns.UserChangePwdRequestColumns;
...
public class UserChangePwdRequestRepository extends AbstractRepository {
    ...
    public static void deleteAssociation(int userId) {
        getDb().executeUpdate(MessageFormat.format("delete from {0} where {1} = ?", TABLE_NAME, UserChangePwdRequestColumns.USER_ID), userId);
    }
