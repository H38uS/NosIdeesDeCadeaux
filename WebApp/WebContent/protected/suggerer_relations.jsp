    ...
    <jsp:body>
            ...
            <form method="POST" class="form-inline" action="protected/suggerer_relations">
                <div class="row align-items-center mx-0">
                    ...
                    <div class="col-5 col-md-auto">
                        <button class="btn btn-primary" type="submit" name="submit" id="submit">Filtrer</button>
                    </div>
                </div>
                <div></div>
        ...
        <c:if test="${not empty users}">
            <div class="container border border-info bg-light rounded my-3 p-2">
                <form id="suggestionForm" method="POST" class="form-inline" action="protected/suggestion_rejoindre_reseau">
