	...
	<jsp:body>
		...
		<table>
			<tr>
				<td>1. Créer</td>
				<td>2. Inviter</td>
				<td>3. Vos listes de cadeaux</td>
				<td>4. Faites plaisir !</td>
			</tr>
			<tr>
				<td>
					Vous créez votre compte et donnez un nom à votre groupe
				</td>
				<td>Par mail, invitez les membres de votre famille, vos amis...</td>
				<td>Suggérez des idées à vos proches et dites ce qui vous ferait plaisir, ou encore vos hobbies, centres d’intérêts...</td>
