...
import static com.mosioj.ideescadeaux.model.repositories.columns.UserChangePwdRequestColumns.EXPIRATION;
import static com.mosioj.ideescadeaux.model.repositories.columns.UserChangePwdRequestColumns.TOKEN_ID;
import static com.mosioj.ideescadeaux.model.repositories.columns.UserChangePwdRequestColumns.USER_ID;
...
public class UserChangePwdRequestRepository extends AbstractRepository {
     ...
     * @param userId The user id.
     */
    public static void deleteAssociation(int userId) {
     ...
     * @param tokenId The token id.
     */
    public static void createNewRequest(int userId, int tokenId) {
