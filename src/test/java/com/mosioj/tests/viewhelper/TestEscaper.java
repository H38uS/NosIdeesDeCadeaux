...
public class TestEscaper {
	...
	public void testTextToHtml() {
		...
		String[] expected = new String[] {
				"<a href=\"https://www.amazon.fr/Fujifilm-Appareil-Impression-Instantanée-Objectif/dp/B009ZM9R4O/ref=sr_1_2?ie=UTF8&qid=1481557517&sr=8-2&keywords=polaroid+fujifilm\">https://www.amazon.fr/Fujifilm-Appareil-Impression-Instantanée-Objectif/dp/B009ZM9R4O/ref=sr_1_2?ie=UTF8&qid=1481557517&sr=8-2&keywords=polaroid+fujifilm</a>",
		...
		for (int i = 0; i < sources.length; i++) {
			assertEquals(Escaper.textToHtml(sources[i]), expected[i]);
		}
	}
